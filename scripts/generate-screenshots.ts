...
const VIEWER_URL =
  "http://localhost:4321/s/#p=eJyrVipTsjLUUUoFkubmxkZmFgZGRjpKmUpW0dFKGSUlBcVW-vopqWV6Jfn6SjpKLq5hCs75ubmleZkllUqxOgg15eXlejmJZYl56aWJRSmZiXrJ-bkgHYdn5ZRk5iYWK-Tll2QmZyYW6ygkJpeUJuZkpiSmKGCakZ6fn56TCtPtDuYpxcbWAgB-4je3";
const SCREENSHOT_DIR = path.join(process.cwd(), "tmp");
